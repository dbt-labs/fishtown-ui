...
export const Button: React.FC<ButtonProps> = ({
  ...
  const classNames = cx(
    ...
    },
    {
      ...
      // Stateful styles
      'dark:focus:tw-ring-active-700': isOutlineButton,
      'tw-text-cool-gray-600 dark:tw-text-cool-gray-300': isEnabledOutline,
      'tw-bg-white dark:tw-bg-true-gray-700': isEnabledOutline,
      'hover:tw-bg-cool-gray-100 dark:hover:tw-bg-true-gray-600': isEnabledOutline,
      'active:tw-bg-cool-gray-100 dark:active:tw-bg-true-gray-600': isEnabledOutline,
